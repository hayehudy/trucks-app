...
import { ScrollView, StyleSheet, Text, TouchableOpacity, TouchableHighlight, View, Alert, Modal } from "react-native";
    ...
    return (
      <>
        <View style={{marginTop: StatusBar.currentHieght || 30}}>
            ...
            <TouchableOpacity
              onPress={()=>{setShowModal(true); let theWork=work; theWork.index=index;setCurrentWork(theWork)}}
              style={{width:10}}>
              ...
              <Modal
                ...
                <View style={styles.centeredView}>
                  <View style={styles.modalView}>                    
                    <Text style={styles.modalText ,{backgroundColor:"orange"}}>Tons or Load:{currentWork.TonsOrLoad}, Product:{currentWork.Product}</Text>
                    <Text style={styles.modalText}>Remove this row?</Text>
                    <TouchableHighlight
                      style={{ ...styles.openButton, backgroundColor: '#2196F3' }}
                      onPress={() => {
                        let theWorks=works;
                        let theNewWorks=theWorks.filter((x,ind)=>{ind!==currentWork.index});
